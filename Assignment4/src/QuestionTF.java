...
/**
 * This class will represent a true/false question
 * @author anshulbharath
 *
 */
public class QuestionTF implements Question {
	...
	public QuestionTF(String question, String correctAnswer, int points) {
	...
	/**
	 * This method will the string of the quesiton
